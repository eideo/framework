/*
 * Licensed to the Apache Software Foundation (ASF) under one or more contributor license agreements. See the NOTICE file distributed with this work for additional information regarding copyright ownership. The ASF
...
/**
 * An internationalization / localization helper class which reduces the bother of handling ResourceBundles and takes care of the common cases of message formating which otherwise require the creation of Object arrays
 * and such.
 * <p>
 ...
 * <p>
 * The StringManager will look for a ResourceBundle named by the package name given plus the suffix of "LocalStrings". In practice, this means that the localized information will be contained in a LocalStrings.properties
 * file located in the package directory of the classpath.
 * <p>
...
public class StringManager {
	...
	public static final synchronized StringManager getManager(String packageName, Locale locale) {
		...
		if (map == null) {
			/*
			 * Don't want the HashMap to be expanded beyond LOCALE_CACHE_SIZE. Expansion occurs when size() exceeds capacity. Therefore keep size at or below capacity. removeEldestEntry() executes after insertion

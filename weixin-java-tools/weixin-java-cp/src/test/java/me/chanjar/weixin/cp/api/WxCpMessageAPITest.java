...
public class WxCpMessageAPITest {
	...
	public void testSendCustomMessage() throws WxErrorException {
		...
		WxCpMessage message2 = WxCpMessage.TEXT().agentId(configStorage.getAgentId()).toUser(configStorage.getUserId()).content("欢迎欢迎，热烈欢迎\n换行测试\n超链接:<a href=\"http://www.baidu.com\">Hello World</a>").build();

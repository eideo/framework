		 ...
		 columns:[sm,new Ext.grid.RowNumberer(),{
	          ...
	          dataIndex:'typeId',
	      	  ...
	      	  renderer:function(value,metadata,record,rowIndex,colIndex){
	      		...
	      		var str='<button title="删除" value=" " class="btn-del" onclick="NewsTypeView.remove('+editId+')">&nbsp</button>';
	      		    str+='&nbsp;&nbsp;<button title="编辑" value=" " class="btn-edit" onclick="NewsTypeView.edit('+editId+')">&nbsp</button>';
	      			str+='&nbsp;&nbsp;<button title="置顶" value=" " class="btn-top" onclick="NewsTypeView.sort('+editId+','+1+')">&nbsp</button>'
	      			str+='&nbsp;&nbsp;<button title="上移" value=" " class="btn-up" onclick="NewsTypeView.sort('+editId+','+2+')">&nbsp</button>'

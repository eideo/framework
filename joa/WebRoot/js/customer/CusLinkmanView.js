...
CusLinkmanView.prototype.grid = function() {
	...
	var cm = new Ext.grid.ColumnModel({
		columns : [sm, new Ext.grid.RowNumberer(), {
					...
					renderer:function(value){
						if(value == '1'){
							return '<img title="先生" src="'+ __ctxPath +'/images/flag/customer/male.png"/>';
						}else{
							return '<img title="女士" src="'+ __ctxPath +'/images/flag/customer/female.png"/>';
						}
					}
				}, {
					header : '所属客户',
					...
					renderer : function(value, metadata, record, rowIndex,
						...
						var str = '<button title="删除" value=" " class="btn-del" onclick="CusLinkmanView.remove('
								+ editId + ')">&nbsp</button>';

 ...
 */
 ...
 parameters.put("noticeId",condition1);
 reportType = request.getParameter("reportType");
 System.out.println("reportType:"+reportType);
 System.out.println("noticeId:" + condition1);
 ...
 Connection conn = dataSource.getConnection();
  ...
  if("pdf".equals(reportType)){
   System.out.println("你要生成的报表类型是pdf");
   ...
   System.out.println("你要生成的报表类型是xls");
   ...
   //否则生成html类型的报表
   System.out.println("你要生成的报表类型是html");

...
public class InMessageDaoImpl extends BaseDaoImpl<InMessage> implements InMessageDao {
	...
	public InMessage findByRead(Long userId) {
		String hql="from InMessage vo where vo.readFlag=0 and vo.delFlag=1 and vo.userId=?";
		Object[] objs = {userId};
	...
	public Integer findByReadFlag(Long userId) {
		String sql="select count(*) from InMessage vo where vo.readFlag=0 and vo.delFlag=1 and vo.userId="+userId;

...
public class CusLinkmanAction extends BaseAction{
	...
	public String get(){
		...
		sb.append(json.exclude(new String[] {"class","custoemr.class"}).prettyPrint(cusLinkman));
		sb.append("}");
	...
	public String save(){
		...
		if(cusLinkman.getCustomerId()!=null){
			if(cusLinkman.getFullname()!=null&&!"".equals(cusLinkman.getFullname())){
				if(cusLinkman.getMobile()!=null&&!"".equals(cusLinkman.getMobile())){
				...
				}else buff.append("msg:'联系人手机不能为空.',");
			}else buff.append("msg:'联系人姓名不能为空.',");

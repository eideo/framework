 ...
 */
public class FormData extends com.htsoft.core.model.BaseModel {
	...
	protected com.htsoft.oa.model.flow.ProcessForm processForm;
	...
	public Object getValue(){
		...
		if(boolValue!=null)return boolValue==1?"是":"否";
	...
	public void setValue(String val,String type){
		try {
			...
			} else if (ParamField.FIELD_TYPE_DATE.equals(type)) {
				this.dateValue = DateUtils.parseDate(val,new String[] { "yyyy-MM-dd" });
	...
	public com.htsoft.oa.model.flow.ProcessForm getProcessForm () {
		return processForm;
	}	
	
	public void setProcessForm (com.htsoft.oa.model.flow.ProcessForm in_processForm) {
	...
	public void setFormId(Long aValue) {
	    if (aValue==null) {
	        ...
	        processForm = new com.htsoft.oa.model.flow.ProcessForm(aValue);
